...
import vapruImage from "./../assets/vapru.jpeg";
...
function Header(props) {
  ...
  return (
    <nav className="w-full sticky z-50 top-0 h-14  bg-vapru-500">
      <div className=" flex items-center justify-between p-2">
        <div className="ml-4 flex items-center justify-between">
          <img className="h-10 w-10 rounded-full" src={vapruImage} alt="Vapru Icon" />
          <h1 className="text-base md:text-lg px-2 font-semibold text-black">
            Vapru
          </h1>
        </div>
        <div>
            <button
            className="hidden md:block text-black font-medium text-base transition duration-300 border-2 hover:border-b-white border-transparent mr-5"
      ...
      {hamActive && (
          ...
          className="md:hidden fixed left-0 top-14 transition duration-300 w-[200px] h-full rounded-r-md text-sm bg-vapru-200 p-3 z-50"
        >
